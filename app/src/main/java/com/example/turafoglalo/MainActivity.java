...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            // Ha az alkalmazásnak még nincs engedélye, akkor kérjük meg a felhasználót
            ActivityCompat.requestPermissions(this,
                    new String[]{Manifest.permission.POST_NOTIFICATIONS},
                    MY_PERMISSIONS_REQUEST_POST_NOTIFICATIONS);
        } else {
            // Ha az alkalmazásnak már van engedélye, akkor folytathatjuk a műveletet
            sendNotification();
        }

        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "myCh")
                .setSmallIcon(android.R.drawable.stat_notify_sync)
                .setContentTitle("Sikeres Bejelentkezes")
                .setContentText("Plusz két pont :)");
        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ObjectAnimator animator = ObjectAnimator.ofFloat(myButton, "scaleX", 1f, 1.5f);
